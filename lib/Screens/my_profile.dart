import 'package:humteampro/Widgets/innerfield.dart';
...
class _MyProfileState extends State<MyProfile> {
  ...
  var fullname, uemail, uimg, username;
  ...
  getuser() async {
    ...
    setState(() {
      ...
      username = _sharedPreferences.getString('uname');
    });
  }
                        ...
                        child: Container(
                          child: CircleAvatar(
                              ...
                              child: CircleAvatar(
                                ...
                                backgroundImage:
                                    //    AssetImage('images/aqib.jfif')
                                    NetworkImage('$uimg', headers: {}),
                              )),
                        )),
                    Flexible(
                      fit: FlexFit.loose,
